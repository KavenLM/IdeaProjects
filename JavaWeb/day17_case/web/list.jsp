...
<div class="container">
    ...
    <div style="float: left">
        <form class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet" method="post">
            <div class="form-group">
                ...
                <input type="text" name="name" value="${cd.name[0]}" class="form-control" id="exampleInputName1" placeholder="张三">
            </div>
            <div class="form-group">
                <label for="exampleInputName2">籍贯</label>
                <input type="text" name="address" value="${cd.address[0]}" class="form-control" id="exampleInputName2" placeholder="重庆">
            </div>
            <div class="form-group">
    ...
    <form method="post" action="${pageContext.request.contextPath}/delSelectedServlet" id="form">
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-default btn-sm"
                       href="javascript:updateUser(${user.id})">修改
                    </a>&nbsp;
                    <a class="btn btn-default btn-sm"
